...
public class HomeGridAdapter extends ArrayAdapter<Application>{
	...
	public HomeGridAdapter(Context context, List<Application> items, String imgurl) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v == null) {
            ...
            v = li.inflate(R.layout.homegrid_item, null);            
        }
        ...
        if(app != null) {
            ...
            final ImageView imageView = (ImageView)v.findViewById(R.id.homeappIcon);
...
//            imageView.setLayoutParams(params);
           ...
           imageView.getLayoutParams().width = 100;
            ...
            TextView titleText = (TextView)v.findViewById(R.id.hometitleTxt);
           // LinearLayout ratingCntr = (LinearLayout)v.findViewById(R.id.ratingCntr);
            TextView dlText = (TextView)v.findViewById(R.id.homedlTxt);
